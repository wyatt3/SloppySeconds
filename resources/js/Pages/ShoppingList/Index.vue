<template>
  ...
  <div class="shopping-list-container">
    <h1 class="mb-3 text-5xl">Shopping List</h1>
    ...
    <div class="presets mb-4 flex gap-2">
      <Button size="small" severity="secondary" outlined @click="setThisWeek">
        This Week
      </Button>
      <Button size="small" severity="secondary" outlined @click="setNextWeek">
        Next Week
      </Button>
      <Button size="small" severity="secondary" outlined @click="setNext2Weeks">
        Next 2 Weeks
      </Button>
    </div>
    ...
    <!-- Empty State -->
    <div
      v-else-if="hasSearched && ingredients.length === 0"
    ...
    >
      ...
      <p class="text-gray-400 text-sm">
        Try selecting a different date range with scheduled meals.
      </p>
    </div>
    ...
    <div v-else-if="ingredients.length > 0" class="shopping-list">
      ...
      <div class="ingredient-list border rounded">
        <div
          v-for="ingredient in ingredients"
          :key="ingredient.id"
          class="ingredient-item flex items-center gap-3 py-3 px-4 border-b border-gray-200 last:border-b-0 hover:bg-gray-50"
          :class="{ 'opacity-50': checkedItems[ingredient.id] }"
        >
          <Checkbox
            v-model="checkedItems[ingredient.id]"
            :binary="true"
          ...
          >
            <span class="ingredient-name font-medium">{{ ingredient.name }}</span>
            <span class="ingredient-amount text-gray-500">
